    ...
    <div className="min-h-screen bg-black text-white">
      <nav className="fixed top-0 w-full z-50 bg-black/80 backdrop-blur-sm border-b border-gray-800">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex gap-8">
            ...
            <Link href="/merch" className="text-purple-400 transition-colors">Merch</Link>
      ...
      <div className="pt-24 px-6">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-5xl font-bold mb-12">Merch</h1>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="bg-gray-800/50 backdrop-blur rounded-lg overflow-hidden hover:bg-gray-800 transition-all hover:scale-105 cursor-pointer border border-gray-700">
                ...
                <div className="p-6">
                  <h3 className="text-xl font-semibold mb-2">D3PRT Tee</h3>
                  <p className="text-purple-400 font-bold mb-4">$29.99</p>
